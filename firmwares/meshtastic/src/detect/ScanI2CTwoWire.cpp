...
#ifdef MESHTONIC_H4M
    if (port == ScanI2C::I2CPort::WIRE) {
        meshtonicTca9548aRegisterMuxedDevices(port, deviceAddresses, foundDevices);
    }
#endif
}
...
{
#ifdef MESHTONIC_H4M
    meshtonicTca9548aSelectForAddress(address.address);
#endif
